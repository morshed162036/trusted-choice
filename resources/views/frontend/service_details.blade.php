            ...
            <div class="col-lg-12">
                <div class="ttm-page-title-row-inner">
                    <div class="page-title-heading">
                        <h2 class="title">Excuistie Leather Patch</h2>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 widget-area sidebar-left">
                    <aside class="widget widget-nav-menu">
                        <ul>
                            <li class="active"><a href="{{ route('service.details') }}"> Excuistie Leather Patch </a>
                            </li>
                            <li><a href="{{ route('service.details') }}"> Fashion Forward Jacquard Elastic</a></li>
                            <li><a href="{{ route('service.details') }}"> Distinactive Print Label</a></li>
                            <li><a href="{{ route('service.details') }}"> Manufacture </a></li>
                            <li><a href="{{ route('service.details') }}"> Stich Fabric </a></li>
                            <li><a href="{{ route('service.details') }}"> We Design Fabric </a></li>
                        </ul>
                    </aside>
                        ...
                        <div class="ttm-service-description">
                            ...
                            <div class="padding_top20 padding_bottom20">
                                <div class="ttm_fatured_image-wrapper">
                                    <img class="img-fluid" src="{{ asset('frontend/images/services/service-1.jfif')}}"
                                        alt="services-1">
                                </div>
                            </div>
