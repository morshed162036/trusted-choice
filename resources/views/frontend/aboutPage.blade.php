            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="ttm_single_image-wrapper text-left">
                        <img class="img-fluid" src="{{ asset('frontend') }}/images/About Sectiontc.jpg" alt="single-09">
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="layer-content">
                                <div class="slick_slider"
                                     data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "arrows":false, "autoplay":false, "dots":false, "infinite":true, "responsive":[{"breakpoint":992,"settings":{"slidesToShow": 1}},{"breakpoint":840,"settings":{"slidesToShow":
    1}}]}'>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title style2">
                            ...
                            <div class="title-desc">
                                <p>Since more than {{ date('Y')-2010 }} years,
<strong>{{ $settings->app_name }}</strong> is operating in the trusted choice market manufacture and
    ...
    <div class="col-lg-4">
        ...
        <div class="featured-imagebox featured-imagebox-post style1">
            <div class="featured-thumbnail">
                <img class="img-fluid" src="{{ asset($blog->featured_photo) }}" alt="">
            </div>
            <div class="featured-content">
