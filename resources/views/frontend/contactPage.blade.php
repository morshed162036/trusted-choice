                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="featured-icon-box icon-align-before-content">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc"><i class="text-danger fa fa-map-marker"></i> Saleh Mansion, 3/10 Naya Paltan Room No. 2H, (1st Floor) , Dhaka-1000</div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="featured-icon-box icon-align-before-content">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc">+88 02 49350554<br></i>fandfaccbd@gmail.com<br> trustedchoicebd@gmail.com<br>www.trustedchoicebd.com</div>
                                        </div>
                                    </div><!-- featured-icon-box end-->
                                </div>
                            </div>
