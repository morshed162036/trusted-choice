                ...
                <div class="col-sm-12">
                    ...
                    <div class="card bg-transparent shadow-none border">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form-horizontal"  action="{{ route('sister-concern.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" required  placeholder="Company Name">
                                        ...
                                        </div> <button type="submit" class="btn btn-primary float-right" >Create Company</button>
