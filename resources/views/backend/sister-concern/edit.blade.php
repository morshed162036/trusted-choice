    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h5 class="content-header-title float-left pr-1 mb-0"><a href="{{ route('sister-concern.index') }}">All Company</a></h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('sister-concern.index') }}"><i class="bx bx-event-plus"></i></a>
                            </li>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card bg-transparent shadow-none border">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form-horizontal"  action="{{ route('sister-concern.update',$company->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title',isset($company->title)?ucwords($company->title):null) }}" required  placeholder="Company Name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <textarea name="description"  class="form-control char-textarea" id="description" rows="3" placeholder="Description here">{{ old('description',isset($company->description)?ucwords($company->description):null) }}</textarea>
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls custom-file">
                                                    ...
                                                    @if($company->logo != null)
                                                        <br><br>
                                                        <img src="{{ asset($company->logo) }}" class="user-profile-image rounded" alt="slider image" style="height: 150px !important; width: 250px !important;" >
                                                        <br><br>
                                                    @else
                                        ...
                                        </div> <button type="submit" class="btn btn-primary float-right" >Update Company</button>
