...
@section('title','Create New CRM')
@section('crmCreate','active')
@section('vendorCSS')
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" required  placeholder="Client Name">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Phone </label>
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="phone" class="form-control" value="{{ old('phone') }}" required  placeholder="Phone No">
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Email </label>
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="email" class="form-control" value="{{ old('email') }}" required  placeholder="Email Address">
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <textarea name="details"  class="form-control char-textarea" id="address-counter" rows="10" placeholder="Write details">{{ old('details') }}</textarea>
                                                    <div class="form-control-position">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="date" id="datetimepicker" class="form-control" value="{{ old('date') }}" required>
                                                    <div class="form-control-position">
                                                        <i class="bx bx-phone"></i>
                                                    </div>
                                                    @error('date')
                                        ...
                                        <div class="col-md-4">
                                            <br>
                                            <button type="submit" class="btn btn-primary float-left" >Create CRM</button>
                                        </div>
                                    </div>
