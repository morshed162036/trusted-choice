                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="service_name" class="form-control" value="{{ old('service_name') }}" required  placeholder="Service Name">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}"  placeholder="Service Title">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="heading" class="form-control" value="{{ old('heading') }}"  placeholder="Service Heading">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('heading')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="short_text" class="form-control" value="{{ old('short_text') }}"  placeholder="Service Short Text">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('short_text')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="long_text" class="form-control" value="{{ old('long_text') }}"  placeholder="Service Long Text">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('long_text')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="description" class="form-control" value="{{ old('description') }}"  placeholder="Service Description">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('description')
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary float-right" >Create Service</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
