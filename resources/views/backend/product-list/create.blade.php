                ...
                <div class="col-sm-12">
                    ...
                    <div class="card bg-transparent shadow-none border">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form-horizontal"  action="{{ route('product-list.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="product_name" class="form-control" value="{{ old('product_name') }}" required  placeholder="Product Name">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}"  placeholder="Product Title">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="heading" class="form-control" value="{{ old('heading') }}"  placeholder="Product Heading">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('heading')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="short_text" class="form-control" value="{{ old('short_text') }}"  placeholder="Product Short Text">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('short_text')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="long_text" class="form-control" value="{{ old('long_text') }}"  placeholder="Product Long Text">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('long_text')
