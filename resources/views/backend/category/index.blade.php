                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('category.index') }}"><i class="bx bx-user-x"></i></a>
                            </li>
...
{{--                                @canany(['deposit.create'])--}}
                                    <a class="btn btn-primary float-right" href="{{ route('category.create') }}">Create New Category</a>
{{--                                @endcanany--}}
                            </h4>
                        </div>
